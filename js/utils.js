...
function zodiacDaily(signId) {
  const d = new Date(), seed = d.getDate() + signId * 7;
  ...
  return {
    ...
    summary: ['今天整体运势不错','今天可能遇到小挑战','今天灵感充沛','今天社交运佳','今天适合休息调整','今天行动力强','今天感情运旺'][seed%7],
    advice: ['保持积极心态','注意控制情绪','多与朋友交流','今天适合学习','注意身体健康','财务宜保守','相信直觉'][(seed+3)%7]
  };
}
